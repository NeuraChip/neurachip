# # Parallel NeuraChip SpMM Compiler
# 
...
mat_A, mat_B = gen_dataset_matrices(DATASET_NAME)
if row_number >= mat_A.x_dim:
	print("ERROR: row_number is greater than or equal to mat_A.x_dim")
	sys.exit()
# print("mat_A dims: ", mat_A.x_dim, mat_A.y_dim)
# print("mat_B dims: ", mat_B.x_dim, mat_B.y_dim)
if row_number == 0:
    print("Generating mat_C")
    mat_C = generate_padded_mat_C(mat_A, mat_B)
    print("Creating DRAM file")
...
get_single_row_program_df(DATASET_NAME, row_number)
if row_number == 0:
